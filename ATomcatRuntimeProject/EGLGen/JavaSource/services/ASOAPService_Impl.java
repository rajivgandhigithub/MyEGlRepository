...
public class ASOAPService_Impl extends com.ibm.javart.resources.Program implements com.ibm.javart.services.ServiceCore2
{
	private static final long serialVersionUID = 70L;
	
	public final ASOAPService_Impl ezeProgram;
	public libraries.ALibrary_Lib libraries__ALibrary;
	
	public ASOAPService_Impl( com.ibm.javart.resources.RunUnit ru ) throws java.lang.Exception
	{
		super( "ASOAPService", "ASOAPService", ru, false, true, 7 );
		ezeProgram = this;
		$initASOAPService_Impl( this );
	}
	...
	{
		return new com.ibm.javart.resources.StartupInfo( "ASOAPService", "services/ASOAPService_Impl.properties", true );
	}
	...
	public void $initASOAPService_Impl( ASOAPService_Impl ezeProgram ) throws java.lang.Exception
	{
