...
public class IASOAPService_wsProxy extends javax.xml.ws.Service implements com.ibm.javart.services.JAXWSReference,java.io.Serializable
{
	...
	private final static java.util.logging.Logger logger = java.util.logging.Logger.getLogger( services.IASOAPService_wsProxy.class.getName() );
	...
	static {
		...
		try {
			url =  services.IASOAPService_wsProxy.class.getResource("/wsdl/ASOAPService.wsdl");
	...
	public IASOAPService_wsProxy() throws Exception
	{
		this(com.ibm.javart.util.ServiceUtilities.runUnit(true));
	}
	
	public IASOAPService_wsProxy( com.ibm.javart.resources.RunUnit ru ) throws Exception
	{
		super(SERVICE_WSDL_LOCATION,new javax.xml.namespace.QName("http://services", "ASOAPServiceService"));
		ezeProgram = new com.ibm.javart.resources.Program("IASOAPService", "IASOAPService", ru, false, true );
		...
		serviceProxy.setPartName( "services.IASOAPService");
	}
